...
<a role="button" href="javascript:;" onclick="toggleChatbot()" id="chatbottoggle" tab-index="1000">
...
<div id="chatbot" style="display: none; position: fixed; z-index: 10000; right: 5px; bottom: 70px; width: 400px; height: 500px; background-color: #fff; border: 1px solid #012d56; border-radius: 5px;">
    <div style="background-color: #012d56; color: #fff; padding: 10px; font-weight: bold;">
        <span style="float: right">
            <a role="button" href="javascript:;" onclick="toggleChatbot()" style="color: #fff">
...
<style>
    #chatbottoggle, #chatbottoggle:active {
        position: fixed;
        display: block;
        right: 30px;
        bottom: 5px;
    ...
    .chatbotresponse ol, .chatbotresponse ul {
