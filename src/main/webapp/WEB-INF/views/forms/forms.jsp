					  ...
					  for (var i = 0; i < list.length; i++ )
					  {
						  ...
						  {			
							  ...
							  if(list[i].formManagementRights && list[i].canCreateSurveys)
							  {
							     ...
							     $(acopy).attr('onclick', "copySurvey('" + list[i].id + "','" + list[i].title + "','" + list[i].language.code + "', '" + list[i].security+ "', '" + list[i].isQuiz + "', '" + list[i].isDelphi + "', '" + list[i].isEVote + "', '" + list[i].eVoteTemplate + "', '" + list[i].isSelfAssessment + "');");
							  } else {
