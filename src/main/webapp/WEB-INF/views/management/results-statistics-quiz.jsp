			...
			<table style="margin-bottom: 20px;">
				...
				<tr>
					<td style="padding-right: 10px;">
						<spring:message code="label.TotalMeanScore" />&#x20;
				...
				<tr>
					<td style="padding-right: 10px;">
						<spring:message code="label.TotalBestScore" />&#x20;
							...
							<table style="margin-bottom: 15px">
								<tr>
									<td style="padding-right: 10px; white-space: nowrap">
										<spring:message code="label.TotalMeanScorePerSection" />&#x20;
								...
								<tr>
									<td style="padding-right: 10px; white-space: nowrap">
										<spring:message code="label.TotalBestScorePerSection" />&#x20;
