	...
	<div class='${responsive != null ? "responsivepage" : "page"}' style='padding: 20px; margin-top: 80px; margin-bottom: 100px; max-width: 600px; margin-left: auto; margin-right: auto'>
		...
		<div style="text-align: left; margin-bottom: 50px;">
			...
			<div style="float: right; width: 400px;">
				...
				<br />
				<a href="/auth/login"><spring:message code="label.BackToLogin" /></a>
				<a style="margin-left: 50px;" href="https://ecas.ec.europa.eu/cas/userdata/mobileApp/manageMyMobileDevices.cgi"><spring:message code="label.RegisterMobileNow" /></a>
			</div>
