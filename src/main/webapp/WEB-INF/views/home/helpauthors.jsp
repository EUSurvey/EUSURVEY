...
<p>If you wish to make your survey WCAG compliant, please follow the instructions explained <a href="https://circabc.europa.eu/sd/a/ff07d724-10bd-41aa-b99b-3b0799a995e8/WCAG_tutorial.pdf" target="_blank">in this document</a>.</p>
...
<p>The confirmation message is what participants see when they have submitted their contribution. To change the default message, open the survey, go to the "Editor" and click on the "Edit Confirmation Page" button. If you have already published your survey, please remember to go to the "Overview" page and click on "Apply Changes".</p>
