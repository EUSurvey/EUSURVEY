...
<h1>entre la Commission européenne et le propriétaire d’une enquête EUSurvey (l’utilisateur)</h1>
<ol class="priv">
    <p>
    ...
    <h4>SONT CONVENUS DE CE QUI SUIT:</h4>
    <h4>Article premier – Parties</h4>
        <p>Le présent accord sur le traitement des données (l’«accord») est établi entre les parties énoncées ci-après: </p>
            <p>
                1. <b>la Commission européenne (la «Commission»)</b> et sa direction générale de l’informatique
                (DG DIGIT) (ci-après le «prestataire de services» ou le «sous-traitant») et
            </p>
            <p>
                2. <b>la personne physique ou morale </b> qui crée une enquête dans l’outil EUSurvey ou pour
        ...
        <p>Les parties sont ci-après dénommées individuellement «partie» et collectivement «parties». </p><br>
    <h4>Article 2 – Champ d’application du présent accord</h4>
        <p>
    ...
    <h4>Article 3 – Nature et finalité du traitement </h4>
        <p>
        ...
        <ul>
            ...
            <li>
                EUSurvey utilise  <a href="https://ec.europa.eu/info/privacy-policy/europa-analytics_fr">
                Europa Analytics</a> pour établir des statistiques relatives au trafic et les analyser. Europa Analytics
    ...
    <h4>Article 4 – Traitement des données à caractère personnel par le prestataire de services en qualité de sous-traitant</h4>
        <p>
        ...
        <p>En ce qui concerne la mise à disposition, l’exploitation et la gestion de l’outil EUSurvey: </p>
        <table class="table-format">
            <tr>
                <td><b>Objet de l’activité de traitement:</b></td>
                <td>Traitement des données à caractère personnel dans le cadre des services fournis au propriétaire de l’enquête,
                    conformément aux conditions générales pour la fourniture de services et au présent accord sur le traitement des données </td>
            </tr>
            <tr>
                <td><b>Durée du traitement:</b></td>
                <td>
                    La Commission ne conserve les données à caractère personnel des utilisateurs que le temps nécessaire
                    pour remplir ses obligations découlant de la fourniture du service aux propriétaires d’enquêtes
                    EUSurvey (utilisateurs). <br>
                    Plus précisément,  <b>les données seront traitées</b>:<br>
                    <ul>
                        <li>aussi longtemps qu’un utilisateur reste actif. </li>
                    </ul>
                    Les données relatives au compte d’un utilisateur et toutes les données associées (informations
                    relatives à EUSurvey, etc.) seront définitivement supprimées:<br>
                    <ul>
                        <li>à la fermeture du compte utilisateur</li>
                        <li>à la demande du titulaire du compte</li>
                        <li>après deux ans d’inactivité sur le compte</li>
                    </ul>
                    <b>Les journaux</b> seront conservés pendant une période maximale de six mois.<br>
                    <b>Politique de sauvegarde </b>: Des sauvegardes sont effectuées quotidiennement
                    et transférées vers une infrastructure de sauvegarde centralisée, gérée par le
                    service afin de garantir une perte de données maximale admissible (PDMA) de 24
                    heures. La période de conservation dépend de la classe liée au service. EUSurvey
                    bénéficie d’une classe de service «or», comprenant des sauvegardes quotidiennes,
                    hebdomadaires et mensuelles qui sont conservées respectivement pendant 35 jours,
                    35 jours et un an. Il est possible que d’autres copies de données supprimées soient
                    également toujours présentes dans nos sauvegardes à des fins de récupération après
                    un incident jusqu’à un an après la suppression. Après cette date, elles seront écrasées. <br>
                </td>
            </tr>
            <tr>
                <td><b>Types de données à caractère personnel qui font l’objet d’un traitement:</b></td>
                <td>
                    <b>Données d’identification</b>: nom complet (prénom et nom) et adresse électronique,
                    identifiant de connexion de l’utilisateur (pour l’authentification par l’intermédiaire d’EU Login).<br>
                    EUSurvey utilise le service <a href="https://ec.europa.eu/info/privacy-policy/europa-analytics_fr">
                    Europa Analytics</a> pour établir des statistiques relatives au trafic et les analyser. Pour de plus
                    amples informations, veuillez consulter le site web d’Europa Analytics. Toutes les données relatives
                    au contenu collectées dans le cadre des enquêtes EUSurvey sont hébergées sur les serveurs de la Commission.<br>
                    All content data collected from EU Surveys are hosted in the servers of the EC.<br>
                    <b>Journaux: </b> les fichiers journaux techniques d’EUSurvey stockent les données relatives
                    aux actions des utilisateurs. Les fichiers journaux contiennent des données sur l’accès de
                    l’utilisateur (enregistrement de l’heure), l’adresse électronique chaque fois qu’un courrier
                    électronique est envoyé à quelqu’un ou le nom d’utilisateur EU Login lorsque le nom d’utilisateur
                    a changé. Dans certains cas, ils peuvent contenir des données relatives à l’utilisateur,
                    telles que les adresses IP, lorsqu’une exception a été soulevée.<br>
                    <b>Cookies:</b> EUSurvey utilise trois cookies différents. Deux d’entre eux proviennent du cck1
                    Kit de consentement pour les cookies) officiel de la Commission européenne et du _pk_id#, tandis
                    ...
                    données à caractère personnel qui pourraient être hébergées sur les serveurs de la Commission
                    européenne. Il convient que le traitement de ces types de données par le propriétaire de l’enquête
                    soit conforme à l’obligation énoncée dans le règlement (UE) 2018/1725 et le règlement (UE) 2016/679.
                </td>
            </tr>
            <tr>
                <td><b>Catégories de personnes concernées:</b></td>
                <td>les propriétaires d’enquêtes (utilisateurs), les participants aux enquêtes et le personnel de
                    la Commission européenne qui participe à l’exploitation, à la gestion et à la maintenance de
                    la plateforme EUSurvey, selon le principe du «besoin d’en connaître». </td>
            </tr>
        </table>
        <p></p>
        <p>
    ...
    <h4>Article 5 – Obligations générales incombant au prestataire de services</h4>
        <p>
    ...
    <h4>Article 6 – Responsabilité de la sécurité du traitement</h4>
        <p>
            Le prestataire de services a adopté des mesures de sécurité techniques et organisationnelles appropriées en ce qui
            concerne les services fournis <sup><a href="#fn2" id="ref2">1</a></sup>. Ces deux types de mesures tiennent dûment compte des risques inhérents au traitement
    ...
    <h4>Article 7 – Gestion des incidents de sécurité, notamment des violations de données à caractère personnel </h4>
        <p>
    ...
    <h4>Article 8 – Demandes présentées par les personnes concernées</h4>
        <p>
    ...
    <h4>ANNEXE 1: Registre des activités de traitement</h4>
    <p>Article 31, paragraphe 2, points a), b), c) et d), du RPDUE – article 30, paragraphe 2, du RGPD</p>
    <table class="table-format">
        <tr>
            <td><b>Nom et coordonnées du sous-traitant des données:</b></td>
            <td>Commission européenne, direction générale de l’informatique (DG DIGIT), unité D1, <a href="https://ec.europa.eu/eusurvey/home/support">formulaire de contact</a></td>
        </tr>
        <tr>
            <td><b>traitement de données à caractère personnel dans le cadre des services fournis au propriétaire de l’enquête:</b></td>
            <td>traitement de données à caractère personnel dans le cadre des services fournis au propriétaire de l’enquête:
                <ul>
                    <li>développement, mise à disposition, exploitation et maintenance d’EUSurvey en tant que service de gestion, notamment toutes les évolutions futures;</li>
                    <li>soutien de deuxième niveau à l’utilisateur d’EUSurvey; </li>
                    <li>assistance et aide techniques aux utilisateurs finaux;</li>
                    <li>hébergement sécurisé de l’ensemble des données à caractère personnel conservées dans le centre de données de la Commission.</li>
                </ul>
            </td>
        </tr>
        <tr>
            <td><b>Transferts de données internationaux:</b></td>
            <td>Sans objet, toutes les données à caractère personnel sont conservées sur les serveurs de la Commission européenne.</td>
        </tr>
        <tr>
            <td><b>Mesures techniques et organisationnelles:</b></td>
            <td>EUSurvey enregistre le nom d’utilisateur EU Login ainsi que les adresses électroniques des propriétaires de l’enquête dans les centres de données de la Commission européenne.<br>
                La Commission européenne a mis en œuvre des mesures de sécurité pour protéger le matériel et les logiciels du serveur ainsi que le réseau contre les manipulations à caractère accidentel ou malveillant et la perte de données. L’ensemble des données sont stockées sur les serveurs de la Commission européenne gérés par la DG DIGIT conformément aux dispositions de sécurité technique énoncées dans la décision (UE, Euratom) 2017/46 de la Commission du 10 janvier 2017 sur la sécurité des systèmes d’information et de communication au sein de la Commission européenne, ses versions ultérieures, ses règles d’application (telles qu’adaptées de temps à autre) et les normes et lignes directrices de sécurité correspondantes, ainsi que dans la décision (UE, Euratom) 2015/443 de la Commission du 13 mars 2015 relative à la sécurité au sein de la Commission, ses modalités d’application et les avis de sécurité correspondants. Ces documents (adaptés de temps à autre) peuvent être consultés à l’adresse suivante:
    ...
    <hr></hr>
    <sup id="fn2">1 Ces mesures organisationnelles comprennent l'utilisation appropriée du service et de ses fonctionnalités.</sup>
</ol>