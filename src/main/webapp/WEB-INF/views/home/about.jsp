...
<body id="bodyHelpAbout">
	...
	<c:choose>
		<c:when test="${USER != null && runnermode == null }">
			...
			<div class="page" style="margin-top: 110px; width: 800px;">
		</c:when>
		<c:when test="${responsive != null }">
			<div class="page" style="margin-top: 40px; width: 100%; padding: 20px;">
		</c:when>
		<c:otherwise>
			<div class="page" style="margin-top: 40px; width: 800px;">
		</c:otherwise>
	</c:choose>
