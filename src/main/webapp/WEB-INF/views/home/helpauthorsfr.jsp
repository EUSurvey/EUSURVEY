...
<body>
	...
	<p>Nous recommandons ces jeux de caractères compatibles:</p>
		<ul>
			...
			<li>Jeu de caractères couramment compatible <a href="https://circabc.europa.eu/sd/a/1eb30efd-e2d8-4c3b-9f55-533bb903f7d0/EUSurvey-SupportedCharacterSet(common).txt" target="_blank">(https://circabc.europa.eu/sd/a/1eb30efd-e2d8-4c3b-9f55-533bb903f7d0/EUSurvey-SupportedCharacterSet(common).txt)</a></li>
		</ul>
	...
	<p>Le message de confirmation est le message que verront les participants après avoir soumis leur contribution. Pour modifier le message par défaut, ouvrez l'enquête, allez à « Propriétés », ensuite allez à « Pages Spéciales » et cliquez sur le bouton « Modifier ». Si vous avez déjà publié votre enquête, n'oubliez pas d'ouvrir la page « Aperçu » et de cliquer sur « Afficher les modifications en attente », puis sur «Appliquer les modifications».</p>
