...
<body>
	...
	<div class="fullpage">	
		<div id="escapeMessageId" style="text-align: center; margin-top: 100px;">${text}</div>	
		
		<c:if test="${oncepublished != null && form.survey.showPDFOnUnavailabilityPage}">
			<div style="text-align: center; margin-top: 40px;">
				<a id="download-survey-pdf-link" class="btn btn-info" onclick="downloadSurveyPDF('${form.survey.id}','${form.language.code}','${uniqueCode}')">${form.getMessage("label.DownloadPDFversion")}</a>
