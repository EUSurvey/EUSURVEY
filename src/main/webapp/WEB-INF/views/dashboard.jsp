	...
	<div class="fixedtitle">
		<div class="fixedtitleinner">
			<div style="float: left">
				<h1>
					<span class="glyphicon glyphicon-dashboard pagetitleicon"></span>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="widget" style="min-height: auto; height: auto; padding: 0px;">
								...
								<img class="center" data-bind="visible: surveys() == null" src="${contextpath}/resources/images/ajax-loader.gif" />
								...
								<table class="table table-striped table-bordered" style="margin-bottom: 10px">
									...
									<!-- ko if: surveysMode() != 'archived' -->									
										...
										<tr>
											...
											<td data-bind="html: numberOfInvitations, visible: $parent.surveysMode() == 'advanced'"></td>
											<td data-bind="html: numberOfDrafts, visible: $parent.surveysMode() == 'advanced'"></td>
