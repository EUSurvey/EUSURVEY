...
public class WebServiceController extends BasicController {
	...
	public @ResponseBody String deleteOldExports(HttpServletRequest request, HttpServletResponse response, Locale locale) throws InterruptedException {	
	...
	@RequestMapping(value = "/createNewTokenList/{shortname}/{active}", method = {RequestMethod.GET, RequestMethod.HEAD}, produces = "text/html")
	public @ResponseBody String createNewTokenList(@PathVariable String shortname, @PathVariable String active, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
			return createNewTokenList(credentials.getKey(), credentials.getValue(), shortname, active, request, response);
		}		
		return "";
	}
	
	private @ResponseBody String createNewTokenList(@PathVariable String login, @PathVariable String pass, @PathVariable String shortname, @PathVariable String active, HttpServletRequest request, HttpServletResponse response) {	
	...
	@RequestMapping(value = "/createTokens/{groupid}/{number}", method = {RequestMethod.GET, RequestMethod.HEAD}, produces = "text/html")
	public @ResponseBody String createTokens(@PathVariable String groupid, @PathVariable String number, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
			return createTokens(credentials.getKey(), credentials.getValue(), groupid, number, request, response, locale);
		}		
		return "";
	}
	
	private @ResponseBody String createTokens(@PathVariable String login, @PathVariable String pass, @PathVariable String groupid, @PathVariable String number, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		...
		try {
			...
			//check that with the new tokens the limit of 1 million tokens per guestlist is not violated
	...
	@RequestMapping(value = "/deactivateToken/{groupid}/{token}", method = {RequestMethod.GET, RequestMethod.HEAD}, produces = "text/html")
	public @ResponseBody String deactivateToken(@PathVariable String groupid, @PathVariable String token, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String deactivateToken(@PathVariable String login, @PathVariable String pass, @PathVariable String groupid, @PathVariable String token, HttpServletRequest request, HttpServletResponse response) {	
	...
	@RequestMapping(value = "/activateToken/{groupid}/{token}", method = {RequestMethod.GET, RequestMethod.HEAD}, produces = "text/html")
	public @ResponseBody String activateToken(@PathVariable String groupid, @PathVariable String token, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String activateToken(@PathVariable String login, @PathVariable String pass, @PathVariable String groupid, @PathVariable String token, HttpServletRequest request, HttpServletResponse response) {	
	...
	@RequestMapping(value = "/deleteToken/{groupid}/{token}", method = {RequestMethod.GET, RequestMethod.HEAD}, produces = "text/html")
	public @ResponseBody String deleteToken(@PathVariable String groupid, @PathVariable String token, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String deleteToken(@PathVariable String login, @PathVariable String pass, @PathVariable String groupid, @PathVariable String token, HttpServletRequest request, HttpServletResponse response) {	
	...
	public @ResponseBody String getResults(@PathVariable String taskid, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String getResults(@PathVariable String login, @PathVariable String pass, @PathVariable String taskid, HttpServletRequest request, HttpServletResponse response) {	
	...
	private @ResponseBody String createResultsNoDates(@PathVariable String login, @PathVariable String pass, @PathVariable String formid, @PathVariable String showids, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
	...
	public @ResponseBody String prepareResultsNoDates(@PathVariable String formid, @PathVariable String showids, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String createResultsStartOnly(@PathVariable String login, @PathVariable String pass, @PathVariable String formid, @PathVariable String showids, @PathVariable String start, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
	...
	public @ResponseBody String prepareResultsStartOnly(@PathVariable String formid, @PathVariable String showids, @PathVariable String start, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String createResults(@PathVariable String login, @PathVariable String pass, @PathVariable String formid, @PathVariable String showids, @PathVariable String start, @PathVariable String end, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		return createResults(login, pass, formid, showids, start, end, request, response, locale, 0, "N", "");
	}
	
	@RequestMapping(value = "/prepareResults/{formid}/{showids}/{start}/{end}", method = {RequestMethod.GET, RequestMethod.HEAD}, produces = "text/html")
	public @ResponseBody String prepareResults(@PathVariable String formid, @PathVariable String showids, @PathVariable String start, @PathVariable String end, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
			return createResults(credentials.getKey(), credentials.getValue(), formid, showids, start, end, request, response, locale);
		}		
		return "";
	}
	...
	public @ResponseBody String prepareResults(@PathVariable String formid, @PathVariable String showids, @PathVariable String start, @PathVariable String end, @PathVariable String type, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	//no dates
	private @ResponseBody String createResultsXMLNoDates(@PathVariable String login, @PathVariable String pass, @PathVariable String formid, @PathVariable String showids, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		return createResults(login, pass, formid, showids, "0", "0", request, response, locale);
	}
	
	@RequestMapping(value = "/prepareResultsXML/{formid}/{showids}", method = {RequestMethod.GET, RequestMethod.HEAD}, produces = "text/html")
	public @ResponseBody String prepareResultsXMLNoDates(@PathVariable String formid, @PathVariable String showids, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String createResultsXMLStart(@PathVariable String login, @PathVariable String pass, @PathVariable String formid, @PathVariable String showids, @PathVariable String start, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
	...
	public @ResponseBody String prepareResultsXMLStart(@PathVariable String formid, @PathVariable String showids, @PathVariable String start, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String createResultsXML(@PathVariable String login, @PathVariable String pass, @PathVariable String formid, @PathVariable String showids, @PathVariable String start, @PathVariable String end, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		return createResults(login, pass, formid, showids, start, end, request, response, locale, 1, "N", "");
	}		
	
	@RequestMapping(value = "/prepareResultsXML/{formid}/{showids}/{start}/{end}", method = {RequestMethod.GET, RequestMethod.HEAD}, produces = "text/html")
	public @ResponseBody String prepareResultsXML(@PathVariable String formid, @PathVariable String showids, @PathVariable String start, @PathVariable String end, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
			return createResultsXML(credentials.getKey(), credentials.getValue(), formid, showids, start, end, request, response, locale);
		}		
		return "";
	}
	...
	public @ResponseBody String prepareResultsXML(@PathVariable String formid, @PathVariable String showids, @PathVariable String start, @PathVariable String end, @PathVariable String type, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String createResultsPDFNoDates(@PathVariable String login, @PathVariable String pass, @PathVariable String formid, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
	...
	public @ResponseBody String prepareResultsPDFNoDates(@PathVariable String formid, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String createResultsPDFNoStart(@PathVariable String login, @PathVariable String pass, @PathVariable String formid, @PathVariable String start, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
	...
	public @ResponseBody String prepareResultsPDFNoStart(@PathVariable String formid, @PathVariable String start, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String createResultsPDF(@PathVariable String login, @PathVariable String pass, @PathVariable String formid, @PathVariable String start, @PathVariable String end, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		return createResults(login, pass, formid, "false", start, end, request, response, locale, 2, "N", "");
	}
	
	@RequestMapping(value = "/prepareResultsPDF/{formid}/{start}/{end}", method = {RequestMethod.GET, RequestMethod.HEAD}, produces = "text/html")
	public @ResponseBody String prepareResultsPDF(@PathVariable String formid, @PathVariable String start, @PathVariable String end, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
			return createResultsPDF(credentials.getKey(), credentials.getValue(), formid, start, end, request, response, locale);
		}		
		return "";
	}
	...
	public @ResponseBody String prepareResultsPDF(@PathVariable String formid, @PathVariable String start, @PathVariable String end, @PathVariable String type, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
...
///////createAllResults///////////
	...
	private @ResponseBody String createAllResults(@PathVariable String login, @PathVariable String pass, @PathVariable String formid, @PathVariable String start, @PathVariable String end, @PathVariable String type, @PathVariable String xml, @PathVariable String pdf, @PathVariable String uploaded, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		String filetypes = "";
	...
	public @ResponseBody String prepareAllResults(@PathVariable String formid, @PathVariable String start, @PathVariable String end, @PathVariable String type, @PathVariable String xml, @PathVariable String pdf, @PathVariable String uploaded, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String createResults(String login, String pass, String formid, String showids, String start, String end, HttpServletRequest request, HttpServletResponse response, Locale locale, int type, String contributionType, String filetypes) {	
		...
		try {
			...
			if (!end.equalsIgnoreCase("0"))
			{
				try {
					...
					//the end filter was implemented for the ui and always adds one day,so we have to patch the date
					//we also add one second so that 23:59:59 also includes the timespan between that and 0:00 of the next day
	...
	public @ResponseBody String prepareResultFromToken(@PathVariable String formid, @PathVariable String token, @PathVariable String showids, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String createResultFromToken(@PathVariable String login, @PathVariable String pass, @PathVariable String formid, @PathVariable String token, @PathVariable String showids, HttpServletRequest request, HttpServletResponse response, Locale locale) {	
	...
	public @ResponseBody String prefill(@PathVariable String shortname, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
	...
	public @ResponseBody String getSurveyPublicationStatus(@PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	public @ResponseBody String getSurveyMetadata(@PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	@RequestMapping(value = "/publishSurvey/{alias}", method = {RequestMethod.GET, RequestMethod.HEAD}, produces = "text/html")
	public @ResponseBody String publishSurvey(@PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	public @ResponseBody String publishSurveyStart(@PathVariable String alias, @PathVariable String start, @PathVariable String end, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String publishSurvey(@PathVariable String login, @PathVariable String pass, @PathVariable String alias, HttpServletRequest request, HttpServletResponse response, String start, String end) {	
		try {
	...
	@RequestMapping(value = "/unpublishSurvey/{alias}", method = {RequestMethod.GET, RequestMethod.HEAD}, produces = "text/html")
	public @ResponseBody String unpublishSurvey(@PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String unpublishSurvey(@PathVariable String login, @PathVariable String pass, @PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
	...
	private @ResponseBody String getSurveyInfo(String type, @PathVariable String login, @PathVariable String pass, @PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		try {
	...
	@RequestMapping(value = "/archiveSurvey/{alias}", method = {RequestMethod.GET, RequestMethod.HEAD}, produces = "text/html")
	public @ResponseBody String archiveSurvey(@PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String archiveSurvey(@PathVariable String login, @PathVariable String pass, @PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		try {
			User user = getUser(request, response, true);
			if (user == null) return "";
	...
	@RequestMapping(value = "/restoreSurvey/{alias}", method = {RequestMethod.GET, RequestMethod.HEAD}, produces = "text/html")
	public @ResponseBody String restoreSurvey(@PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String restoreSurvey(@PathVariable String login, @PathVariable String pass, @PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		try {
			User user = getUser(request, response, true);
			if (user == null) return "";
	...
	@RequestMapping(value = "/deleteSurvey/{alias}", method = {RequestMethod.GET, RequestMethod.HEAD}, produces = "text/html")
	public @ResponseBody String deleteSurvey(@PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String deleteSurvey(@PathVariable String login, @PathVariable String pass, @PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		try {
			User user = getUser(request, response, true);
			if (user == null) return "";
	...
	@RequestMapping(value = "/getSurveyPDF/{alias}", method = {RequestMethod.GET, RequestMethod.HEAD}, produces = "text/html")
	public @ResponseBody String getSurveyPDF(@PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String getSurveyPDF(@PathVariable String login, @PathVariable String pass, @PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		try {
			User user = getUser(request, response, true);
			if (user == null) return "";
	...
	public @ResponseBody String changeSurveyTitle(@PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String changeSurveyTitle(@PathVariable String login, @PathVariable String pass, @PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		try {
			User user = getUser(request, response, true);
			if (user == null) return "";
	...
	public @ResponseBody String changeContact(@PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String changeContact(@PathVariable String login, @PathVariable String pass, @PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		try {
			User user = getUser(request, response, true);
			if (user == null) return "";
	...
	public @ResponseBody String uploadBackgroundDocument(@PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String uploadBackgroundDocument(@PathVariable String login, @PathVariable String pass, @PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		try {
			User user = getUser(request, response, true);
			if (user == null) return "";
	        ...
	        survey.getBackgroundDocuments().put(label, servletContext.getContextPath() + "/files/" + survey.getUniqueId() + "/" + uid);
	...
	@RequestMapping(value = "/removeBackgroundDocument/{alias}", method = {RequestMethod.DELETE}, produces = "text/html")
	public @ResponseBody String removeBackgroundDocument(@PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String removeBackgroundDocument(@PathVariable String login, @PathVariable String pass, @PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		try {
			User user = getUser(request, response, true);
			if (user == null) return "";
	...
	public @ResponseBody String addUsefulLink(@PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String addUsefulLink(@PathVariable String login, @PathVariable String pass, @PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		try {
			User user = getUser(request, response, true);
			if (user == null) return "";
	...
	public @ResponseBody String removeUsefulLink(@PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String removeUsefulLink(@PathVariable String login, @PathVariable String pass, @PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		try {
			User user = getUser(request, response, true);
			if (user == null) return "";
	...
	@RequestMapping(value = "/applyChanges/{alias}", method = {RequestMethod.GET, RequestMethod.HEAD}, produces = "text/html")
	public @ResponseBody String applyChanges(@PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String applyChanges(@PathVariable String login, @PathVariable String pass, @PathVariable String alias, HttpServletRequest request, HttpServletResponse response) {	
		try {
			User user = getUser(request, response, true);
			if (user == null) return "";
	...
	@RequestMapping(value = "/contributionToDraft/{code}", method = {RequestMethod.GET, RequestMethod.HEAD}, produces = "text/html")
	public @ResponseBody String contributionToDraft(@PathVariable String code, HttpServletRequest request, HttpServletResponse response) {	
		KeyValue credentials = getLoginAndPassword(request, response);
		if (credentials != null)
		{
	...
	private @ResponseBody String contributionToDraft(@PathVariable String login, @PathVariable String pass, @PathVariable String code, HttpServletRequest request, HttpServletResponse response) {	
		try {
			User user = getUser(request, response, true);
			if (user == null) return "";
