...
public class RunnerController extends BasicController {
    ...
    private @Value("${smtpserver}")
    String smtpServer;
    private @Value("${smtp.port}")
    String smtpPort;
    ...
    public String contactformPOST(@PathVariable String uidorshortname, HttpServletRequest request, ModelMap model)
        ...
        String text = IOUtils.toString(inputStream, StandardCharsets.UTF_8).replace("[CONTENT]", body).replace("[HOST]", serverPrefix);
    ...
    public @ResponseBody
    String delete(@PathVariable String id, @PathVariable String uniqueCode,
    ...
    @RequestMapping(value = "/createanswerpdf/{code}", headers = "Accept=*/*", method = {RequestMethod.GET,
            RequestMethod.HEAD})
    public @ResponseBody
    String createanswerpdf(@PathVariable String code, HttpServletRequest request,
                           HttpServletResponse response) {
        try {
            AnswerSet answerSet = answerService.get(code);
    ...
    @RequestMapping(value = "/createdraftanswerpdf/{code}", headers = "Accept=*/*", method = {RequestMethod.GET,
            RequestMethod.HEAD})
    public @ResponseBody
    String createdraftanswerpdf(@PathVariable String code, HttpServletRequest request,
                                HttpServletResponse response) {
        try {
    ...
    @RequestMapping(value = "/createquizpdf/{code}", headers = "Accept=*/*", method = {RequestMethod.GET,
            RequestMethod.HEAD})
    public @ResponseBody
    String createquizpdf(@PathVariable String code, HttpServletRequest request,
                         HttpServletResponse response) {
        try {
    ...
    public @ResponseBody
    String sendDraftLinkByMail(HttpServletRequest request, HttpServletResponse response) {
    ...
    public @ResponseBody
    List<Element> element(@PathVariable String id, HttpServletRequest request,
                          HttpServletResponse response)
    ...
    private ResponseEntity<DelphiTable> handleDelphiTableTable(Table question) {
        ...
        for (Map.Entry<Integer, List<DelphiContribution>> entry : groupedContributions.entrySet()) {
            entry.getValue().sort(Comparator.comparingInt(DelphiContribution::getColumn).thenComparingInt(DelphiContribution::getRow));
