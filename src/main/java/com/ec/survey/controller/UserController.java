...
public class UserController extends BasicController {
	...
	@RequestMapping
	public ModelAndView users(HttpServletRequest request, Model model) throws NotAgreedToTosException {	
	...
	public ModelAndView deleteUser(@RequestParam("id") String id, HttpServletRequest request,  Model model, Locale locale) throws NotAgreedToTosException {	
