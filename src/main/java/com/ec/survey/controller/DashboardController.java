...
public class DashboardController extends BasicController {
	...
	public @ResponseBody Contributions contributions(HttpServletRequest request, HttpServletResponse response, Locale locale, Model model) {
		try {
	...
	public @ResponseBody String[] metadata(HttpServletRequest request, HttpServletResponse response, Locale locale, Model model) {
		try {
	...
	public @ResponseBody int[] surveystates(HttpServletRequest request, HttpServletResponse response, Locale locale, Model model) {
		try {			
			User u = sessionService.getCurrentUser(request);			
	...
	public @ResponseBody List<Survey> surveys(HttpServletRequest request, HttpServletResponse response, Locale locale, Model model) {
		try {
	...
	public @ResponseBody List<Object[]> personalcontributions(HttpServletRequest request, HttpServletResponse response, Locale locale, Model model) {
		try {
	...
	public @ResponseBody List<Object[]> personaldrafts(HttpServletRequest request, HttpServletResponse response, Locale locale, Model model) {
		try {
			...
			for (AnswerSet answerSet : answerSets)
			{
				...
				String link = invitation == null ? "" : host + "runner/invited/" + invitation.getParticipationGroupId() + "/" + invitation.getUniqueId();
	...
	public @ResponseBody List<Object[]> personalinvitations(HttpServletRequest request, HttpServletResponse response, Locale locale, Model model) {
		try {
			...
			for (Invitation invitation : lstInvitations)
			{
				...
				answer[4] = host + "runner/invited/" + invitation.getParticipationGroupId() + "/" + invitation.getUniqueId();
	...
	public @ResponseBody int[] contributionstates(HttpServletRequest request, HttpServletResponse response, Locale locale, Model model) {
		try {
			
			User u = sessionService.getCurrentUser(request);
			int[] contributiondata = answerService.getContributionStatisticsForUser(u.getId());	
