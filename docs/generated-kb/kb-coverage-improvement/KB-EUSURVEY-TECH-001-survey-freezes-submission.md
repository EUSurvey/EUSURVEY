...
* tags: freeze, submission error, loading, timeout, cannot submit, stuck, 500 error
* synonyms: survey freezes when I submit, submission not working, cannot complete survey, survey hangs on submit, error submitting survey, survey stuck loading
